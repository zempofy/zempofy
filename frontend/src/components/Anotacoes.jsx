...
const s = {
  ...
  btnNova: { background: 'linear-gradient(135deg, #22C55E, #1A6B3C)', color: '#fff', border: 'none', borderRadius: '10px', padding: '10px 20px', fontFamily: 'var(--fonte-corpo)', fontWeight: '600', fontSize: '0.875rem', cursor: 'pointer' },
  ...
  cardTitulo: { fontFamily: 'var(--fonte-corpo)', fontWeight: '700', fontSize: '0.95rem', color: 'var(--texto)', margin: 0, flex: 1, lineHeight: '1.3', wordBreak: 'break-word', overflowWrap: 'break-word' },
  ...
  btnVerMais: { background: 'none', border: 'none', color: 'var(--verde)', fontSize: '0.75rem', cursor: 'pointer', padding: '4px 0', fontFamily: 'var(--fonte-corpo)' },
  cardData: { fontSize: '0.7rem', color: 'var(--texto-apagado)', margin: 0 },

  modalTituloTexto: { fontFamily: 'var(--fonte-corpo)', fontWeight: '700', fontSize: '1rem', color: 'var(--texto)' },
  // Modal
