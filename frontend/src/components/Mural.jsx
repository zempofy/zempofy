...
const s = {
  ...
  btnNovo: { background: 'linear-gradient(135deg, #22C55E, #1A6B3C)', color: '#fff', border: 'none', borderRadius: '10px', padding: '10px 20px', fontFamily: 'var(--fonte-corpo)', fontWeight: '600', fontSize: '0.875rem', cursor: 'pointer' },
  ...
  cardTitulo: { fontFamily: 'var(--fonte-corpo)', fontWeight: '700', fontSize: '1.1rem', color: 'var(--texto)', margin: 0 },
  ...
  btnVerMais: { background: 'none', border: 'none', color: 'var(--verde)', fontSize: '0.8rem', cursor: 'pointer', padding: '4px 0', fontFamily: 'var(--fonte-corpo)', marginTop: '4px' },
  ...
  autorAvatar: { width: '32px', height: '32px', minWidth: '32px', background: 'linear-gradient(135deg, #22C55E, #1A6B3C)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--fonte-corpo)', fontWeight: '700', fontSize: '13px', color: '#fff' },
  ...
  reacaoBotao: { background: 'var(--input)', border: '1px solid var(--borda)', borderRadius: '20px', padding: '4px 10px', fontSize: '0.82rem', cursor: 'pointer', color: 'var(--texto)', transition: 'all 0.15s', fontFamily: 'var(--fonte-corpo)' },
  ...
  input: { background: 'var(--input)', border: '1px solid var(--borda)', borderRadius: '10px', padding: '10px 14px', color: 'var(--texto)', fontSize: '0.9rem', width: '100%', fontFamily: 'var(--fonte-corpo)', outline: 'none' },
  textarea: { background: 'var(--input)', border: '1px solid var(--borda)', borderRadius: '10px', padding: '10px 14px', color: 'var(--texto)', fontSize: '0.9rem', width: '100%', fontFamily: 'var(--fonte-corpo)', outline: 'none', resize: 'vertical', lineHeight: '1.5' },
  btnUpload: { display: 'flex', alignItems: 'center', gap: '8px', background: 'var(--input)', border: '1px dashed var(--borda)', borderRadius: '10px', padding: '12px 16px', color: 'var(--texto-apagado)', fontSize: '0.875rem', cursor: 'pointer', fontFamily: 'var(--fonte-corpo)', transition: 'border-color 0.15s' },
  ...
  btnRemoverImagem: { background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: '8px', padding: '6px 12px', color: '#FCA5A5', fontSize: '0.8rem', cursor: 'pointer', fontFamily: 'var(--fonte-corpo)', alignSelf: 'flex-start' },
  ...
  btnSalvar: { flex: 1, padding: '10px', borderRadius: '10px', background: 'linear-gradient(135deg, #22C55E, #1A6B3C)', border: 'none', color: '#fff', fontSize: '0.9rem', cursor: 'pointer', fontFamily: 'var(--fonte-corpo)', fontWeight: '600' },
