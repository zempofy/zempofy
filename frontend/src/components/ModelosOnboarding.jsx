...
const s = {
  ...
  btnVoltar: { background: 'none', border: 'none', color: 'var(--texto-apagado)', fontSize: '0.8rem', cursor: 'pointer', fontFamily: 'Inter, sans-serif', padding: '0', display: 'flex', alignItems: 'center', gap: '4px' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(190px, 1fr))', gap: '10px' },
  card: { background: 'var(--card)', border: '1px solid var(--borda)', borderRadius: '12px', padding: '12px 14px', display: 'flex', flexDirection: 'column', cursor: 'pointer', transition: 'border-color 0.15s' },
  cardNovo: { alignItems: 'center', justifyContent: 'center', minHeight: '96px', border: '1px dashed var(--borda)' },
  cardNome: { fontSize: '0.86rem', fontWeight: '600', color: 'var(--texto)', margin: 0, fontFamily: 'Inter, sans-serif', letterSpacing: '-0.01em' },
  cardDesc: { fontSize: '0.75rem', color: 'var(--texto-apagado)', marginTop: '3px', fontFamily: 'Inter, sans-serif' },
  cardMeta: { fontSize: '0.68rem', color: 'var(--texto-apagado)', marginTop: '5px', fontFamily: 'Inter, sans-serif' },
  btnAcao: { background: 'none', border: '1px solid var(--borda)', borderRadius: '7px', color: 'var(--texto-apagado)', fontSize: '0.74rem', cursor: 'pointer', padding: '5px 10px', fontFamily: 'Inter, sans-serif' },
  vazioBox: { textAlign: 'center', marginTop: '48px', display: 'flex', flexDirection: 'column', alignItems: 'center' },
  // Detalhe do modelo
  setorBloco: { background: 'var(--card)', border: '1px solid var(--borda)', borderRadius: '11px', padding: '12px 14px', transition: 'border-color 0.2s' },
  setorHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '9px' },
  setorNome: { fontSize: '0.83rem', fontWeight: '600', color: 'var(--texto)', fontFamily: 'Inter, sans-serif' },
  ...
  atividadeLinha: { display: 'flex', alignItems: 'center', gap: '9px', padding: '6px 4px', borderBottom: '1px solid var(--borda)', position: 'relative' },
  atividadeDesc: { fontSize: '0.8rem', color: 'var(--texto)', flex: 1, fontFamily: 'Inter, sans-serif' },
