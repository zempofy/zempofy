...
const styles = {
  ...
  logoIcone: {
    ...
    fontFamily: 'var(--fonte-corpo)', fontWeight: '800', fontSize: '18px', color: '#fff',
    boxShadow: '0 2px 8px rgba(0,177,65,0.35)',
  },
  logoNome: { fontFamily: 'var(--fonte-corpo)', fontWeight: '700', fontSize: '20px', color: 'var(--texto)', letterSpacing: '-0.5px' },
  ...
  botao: {
    ...
    padding: '14px', fontFamily: 'var(--fonte-corpo)',
  ...
  linkTermos: { background: 'none', border: 'none', color: '#00b141', cursor: 'pointer', fontWeight: '600', fontSize: '0.85rem', padding: 0, fontFamily: 'var(--fonte-corpo)', textDecoration: 'underline' },
  ...
  termosTitulo: { fontWeight: '700', fontSize: '1rem', color: 'var(--texto)', fontFamily: 'var(--fonte-corpo)' },
